...
console.log("le script game.js de la V1 a bien été lancé");
...
function CheckIMG(secondeImgCharge) {
	...
	imgFullCharge = true; //testeur pour voir si toutes les images sont chargées
...
function Background(para){ //fonction qui s'occupe du background
	if(para == "b"){// b background
		ctx.fillStyle = "#777";
		ctx.fillRect(0, 0, canvas.width, canvas.height);//font gris
	...
	if(para == "o"){ //o over
		...
		ctx.font = '62px Minecraft Regular, MinecraftiaRegular, cursive';
		ctx.textAlign = "left";
		ctx.fillText('SCORE : ' + score, 10, 55 + animationScore);

		if(clignotementCoeur > 0){
			if(clignotementCoeur%5 < 3){
				for (var i = 0; i <= (joker + 1); i++) { //affichage des vies
			...
			for (var i = 0; i <= joker; i++) { //affichage des vies
				ctx.drawImage(imgTileset, 16, 32, 11, 9, 1200 - 75 * i, 15 + animationCoeur, 66, 54);
			}
			/*for(var i = 0;i < 3-joker; i++){ //affichage des coeur mort
				ctx.drawImage(imgTileset, 48, 48, 11, 11, 975 + 75 * i, 15, 66, 66);
...
function boucleMode() {
	...
	if (compteurFrameButtonMode > 20) { compteurFrameButtonMode = 0 }
	...
	if (mode == 0) {
		...
		if (positionCurseur != 1) {	//affichage de l'animation pour le boutton 1player
			if (compteurFrameButtonMode >= 0 && compteurFrameButtonMode <= 5) {
				ctx.drawImage(imgTileset1p, 0, 0, 64, 32, 230, 436, 256, 128);
			}
			if (compteurFrameButtonMode > 5 && compteurFrameButtonMode <= 10) {
				ctx.drawImage(imgTileset1p, 0, 32, 64, 32, 230, 436, 256, 128);
			}
			if (compteurFrameButtonMode > 10 && compteurFrameButtonMode <= 15) {
				ctx.drawImage(imgTileset1p, 0, 64, 64, 32, 230, 436, 256, 128);
			}
			...
			if (compteurFrameButtonMode >= 0 && compteurFrameButtonMode <= 5) {
				ctx.drawImage(imgTileset1p, 64, 0, 64, 32, 230, 436, 256, 128);
			}
			if (compteurFrameButtonMode > 5 && compteurFrameButtonMode <= 10) {
				ctx.drawImage(imgTileset1p, 64, 32, 64, 32, 230, 436, 256, 128);
			}
			if (compteurFrameButtonMode > 10 && compteurFrameButtonMode <= 15) {
				ctx.drawImage(imgTileset1p, 64, 64, 64, 32, 230, 436, 256, 128);
			}
			if (compteurFrameButtonMode > 15 && compteurFrameButtonMode <= 20) {
				ctx.drawImage(imgTileset1p, 64, 32, 64, 32, 230, 436, 256, 128);
			}
		...
		if (positionCurseur != 2) {	//affichage de l'animation pour le boutton 2player
			if (compteurFrameButtonMode >= 0 && compteurFrameButtonMode <= 5) {
				ctx.drawImage(imgTileset2p, 0, 0, 64, 32, 714, 436, 256, 128);
			}
			if (compteurFrameButtonMode > 5 && compteurFrameButtonMode <= 10) {
				ctx.drawImage(imgTileset2p, 0, 32, 64, 32, 714, 436, 256, 128);
			}
			if (compteurFrameButtonMode > 10 && compteurFrameButtonMode <= 15) {
				ctx.drawImage(imgTileset2p, 0, 64, 64, 32, 714, 436, 256, 128);
			}
			if (compteurFrameButtonMode > 15 && compteurFrameButtonMode <= 20) {
				ctx.drawImage(imgTileset2p, 0, 32, 64, 32, 714, 436, 256, 128);
			}
			...
			if (compteurFrameButtonMode >= 0 && compteurFrameButtonMode <= 5) {
				ctx.drawImage(imgTileset2p, 64, 0, 64, 32, 714, 436, 256, 128);
			}
			if (compteurFrameButtonMode > 5 && compteurFrameButtonMode <= 10) {
				ctx.drawImage(imgTileset2p, 64, 32, 64, 32, 714, 436, 256, 128);
			}
			if (compteurFrameButtonMode > 10 && compteurFrameButtonMode <= 15) {
				ctx.drawImage(imgTileset2p, 64, 64, 64, 32, 714, 436, 256, 128);
			}
			if (compteurFrameButtonMode > 15 && compteurFrameButtonMode <= 20) {
				ctx.drawImage(imgTileset2p, 64, 32, 64, 32, 714, 436, 256, 128);
			}
		...
		if (positionCurseur != 1) {	//affichage de l'animation pour le boutton 1player
			if (compteurFrameButtonMode >= 0 && compteurFrameButtonMode <= 5) {
				ctx.drawImage(imgTilesetnormal, 0, 0, 64, 32, 230, 436, 256, 128);
			}
			if (compteurFrameButtonMode > 5 && compteurFrameButtonMode <= 10) {
				ctx.drawImage(imgTilesetnormal, 0, 32, 64, 32, 230, 436, 256, 128);
			}
			if (compteurFrameButtonMode > 10 && compteurFrameButtonMode <= 15) {
				ctx.drawImage(imgTilesetnormal, 0, 64, 64, 32, 230, 436, 256, 128);
			}
			if (compteurFrameButtonMode > 15 && compteurFrameButtonMode <= 20) {
				ctx.drawImage(imgTilesetnormal, 0, 32, 64, 32, 230, 436, 256, 128);
			}
			...
			if (compteurFrameButtonMode >= 0 && compteurFrameButtonMode <= 5) {
				ctx.drawImage(imgTilesetnormal, 64, 0, 64, 32, 230, 436, 256, 128);
			}
			if (compteurFrameButtonMode > 5 && compteurFrameButtonMode <= 10) {
				ctx.drawImage(imgTilesetnormal, 64, 32, 64, 32, 230, 436, 256, 128);
			}
			if (compteurFrameButtonMode > 10 && compteurFrameButtonMode <= 15) {
				ctx.drawImage(imgTilesetnormal, 64, 64, 64, 32, 230, 436, 256, 128);
			}
			if (compteurFrameButtonMode > 15 && compteurFrameButtonMode <= 20) {
				ctx.drawImage(imgTilesetnormal, 64, 32, 64, 32, 230, 436, 256, 128);
			}
		...
		if (positionCurseur != 2) {	//affichage de l'animation pour le boutton 2player
			if (compteurFrameButtonMode >= 0 && compteurFrameButtonMode <= 5) {
				ctx.drawImage(imgTilesethard, 0, 0, 64, 32, 714, 436, 256, 128);
			}
			if (compteurFrameButtonMode > 5 && compteurFrameButtonMode <= 10) {
				ctx.drawImage(imgTilesethard, 0, 32, 64, 32, 714, 436, 256, 128);
			}
			if (compteurFrameButtonMode > 10 && compteurFrameButtonMode <= 15) {
				ctx.drawImage(imgTilesethard, 0, 64, 64, 32, 714, 436, 256, 128);
			}
			if (compteurFrameButtonMode > 15 && compteurFrameButtonMode <= 20) {
				ctx.drawImage(imgTilesethard, 0, 32, 64, 32, 714, 436, 256, 128);
			}
			...
			if (compteurFrameButtonMode >= 0 && compteurFrameButtonMode <= 5) {
				ctx.drawImage(imgTilesethard, 64, 0, 64, 32, 714, 436, 256, 128);
			}
			if (compteurFrameButtonMode > 5 && compteurFrameButtonMode <= 10) {
				ctx.drawImage(imgTilesethard, 64, 32, 64, 32, 714, 436, 256, 128);
			}
			if (compteurFrameButtonMode > 10 && compteurFrameButtonMode <= 15) {
				ctx.drawImage(imgTilesethard, 64, 64, 64, 32, 714, 436, 256, 128);
			}
			if (compteurFrameButtonMode > 15 && compteurFrameButtonMode <= 20) {
				ctx.drawImage(imgTilesethard, 64, 32, 64, 32, 714, 436, 256, 128);
			}
...
function SetupGame() {
	...
	if (mode == 1 && difficulte == 1) { //en mode un joueur et facile
		...
		per1type = 0; //numéro de poubelle acctuel modification de valeur pour chager
		per2type = 1; //numéro de poubelle acctuel modification de valeur pour chager
		...
		per2etat = 1; //player 2 on
		per1type = 0; //numéro de poubelle acctuel modification de valeur pour chager
		per2type = 2; //numéro de poubelle acctuel modification de valeur pour chager
		per1X = 800;//position de la poubelle
		per1Y = 845;
		per2X = 400;//position de la poubelle
		per2Y = 955;
		...
		if (d == 1) { fourthTrash = "unrecycable" }
		if (d == 2) { fourthTrash = "paper" }
		if (d == 3) { fourthTrash = "plastic" }
		if (d == 4) { fourthTrash = "green" }
	}
...
function boucleGame() {
	...
	if (mode == 1) {
		...
		if (difficulte == 1) {
			//il n'y a pas de changement de poubelle en 2 joueur facile
	...
	if(compteurLapsTime % (4 + joker*2) == 0){
		animationCoeur = 3
	}
	if(compteurLapsTime%(8 + joker*4) == 0){
		animationCoeur = -2
	}
	...
	if (para == "u") {
		if (mode == 1 && difficulte == 1) {//1 joueur difficulté 1
			if (compteurLapsTime + (totalItemCollect / 1.5) > lapsTime && collectionOfObjets.length < 10) { //tous les certains interval de temps
				...
				collectionOfObjets.push(new objets(type2, nb_random(0, 11) * 100, 0 - perSize))
			}
		}
		...
		if (mode == 2 && difficulte == 2) {//1 joueur difficulté 1
			if (compteurLapsTime + (totalItemCollect / 1.5) > lapsTime && collectionOfObjets.length < 10) { //tous les certains interval de temps
				compteurLapsTime = 0; //remettre à 0 le comteur de temps
				var type1 = nb_random(1, 4)  //choisir la poubelle
				var type2; //couleur du déchet
...
function BoucleGameOver() {
	...
	if (transitionGamrOver >= 10) {
		...
		ctx.fillRect(0, 0, canvas.width, canvas.height);//font noir
		ctx.fillStyle = "#FFF";
		ctx.font = '102px Minecraft Regular, MinecraftiaRegular, cursive';
		ctx.textAlign = "center";
		ctx.fillText('SCORE : ' + score, 600, 525);
	}
	if (transitionGamrOver == 130) { //vidage de mémoire;
		couldownEnter = 1
		gameOver = 0;
		mode = 0;
		difficulte = 0;
...
function playAudio(audio) {
	...
	/*if(audio == 4){//10 points
		tenPointsAudio.pause();
		tenPointsAudio.currentTime = 0;
		tenPointsAudio.play();
	}*/
	if(audio == 5){
		loseAudio.pause();
